...
<div id="body-wrap">
  ...
  <div class="tab-pane active" id="pane-heatmap">
    <div id="hm-controls" style="border-bottom:1px solid #ddd;background:#f5f5f5;flex-shrink:0;display:flex;align-items:center;padding:3px 10px;gap:8px;flex-wrap:wrap">
      ...
      <button id="btn-hm-custom" onclick="hmEnterCustom()" style="margin-left:auto;padding:2px 10px;font-size:11px;border:1px solid #4a90d9;color:#4a90d9;border-radius:3px;background:#fff;cursor:pointer;font-weight:600">&#9998; Custom selection</button>
    </div>
